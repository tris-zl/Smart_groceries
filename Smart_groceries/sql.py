...
create_table_users = "CREATE TABLE users (name VARCHAR(100), last_name VARCHAR(100), email VARCHAR(50), password VARCHAR(50), team_id int, FOREIGN KEY(team_id) REFERENCES teams(id));"
